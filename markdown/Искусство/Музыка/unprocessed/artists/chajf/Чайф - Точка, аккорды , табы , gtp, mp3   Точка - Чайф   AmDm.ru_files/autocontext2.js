...
Begun.Scripts.importAllScripts({"acp/begun_utils.39805.js":true});
...
Begun.DOM_TIMEOUT=1;
Begun.REVISION='$LastChangedRevision: 41740 $';
...
if(_this.bannersContainViewType('rich',pad.pad_id)&&!_this.isRichExpanded(block)){
...
var ext={
"begun_tpl_block_120x600":"39838",
"begun_tpl_block_160x600":"39838",
"begun_tpl_block_200x300":"39838",
"begun_tpl_block_240x400":"39838",
"begun_tpl_block_468x60":"41125",
"begun_tpl_block_728x90":"39838",
"begun_tpl_block_flat":"39838",
"begun_tpl_block_horizontal":"39838",
"begun_tpl_block_rich":"39466",
"begun_tpl_block_square":"39838",
"begun_tpl_block_top":"39466",
"begun_tpl_block_vertical":"40600"
}
...
tns_text_counter:'http://www.tns-counter.ru/V13a***R>{{referrer}}*bg_ru/ru/CP1251/tmsec={{tns_counter_flag}}/',
...
alter_geo_script:'http://platform.altergeo.ru/js/altergeo-1.5-begun.js',
alter_geo_logger:'http://autocontext.begun.ru/altergeo?token={{token}}',
turnoff_handler:'http://autocontext.begun.ru/hide.jsp?'
},
stubs:{
...
loadModule(isTurnoff,"auto_turnoff.js");
};
this.draw=function(){
...
var altergeoFlag=(function(){
return window.begunAds&&window.begunAds.params&&window.begunAds.params.altergeo_needed;
})();
if(!arguments.callee.altergeoIncluded&&altergeoFlag){
Begun.Utils.includeScript(_this.Strings.urls.alter_geo_script);
arguments.callee.altergeoIncluded=true;
}
...
Begun.Utils.includeCounter(_this.Strings.urls.tns_text_counter,{"referrer":document.referrer.replace(/\*/g,'%2a'),"tns_counter_flag":tnsCounterFlag});
try{
...
if(!vars.favicon){
if(_this.checkBannerViewType(banner,'rich')||_this.isRichExpanded(block)){
...
var is_use_rich=_this.isRichExpanded(block)?'_rich_exp':'_rich';
}else{
...
if(_this.Blocks.checkType(block,'rich')||_this.Blocks.checkViewType(block,'rich')){
var elem=_this.Blocks.getDomObj(block.id);
if(elem){
Begun.Utils.addClassName(elem,'begun_auto_rich');
}
if(!blockBannersContainViewType('rich',pad.pad_id)){
...
var blockVisible=Begun.Utils.findPos(dom_obj)&&
(Begun.Utils.findPos(dom_obj).top<Begun.Utils.countWindowSize().height+Begun.Utils.getScrollXY().y)&&
(Begun.Utils.findPos(dom_obj).left<Begun.Utils.countWindowSize().width+Begun.Utils.getScrollXY().x);
...
#begun_block_{{block_id}} .begun_adv_title a.begun_cross {opacity: 0.35;filter:alpha(opacity=35);} /* no !important for turnoff */\
';
css['forOperaIE']='\
...
var pads=ac.Pads.getPads();
for(var n=0,ln=pads.length;n<ln;n++){
var allBanners=ac.getBanners(pads[n].pad_id);
if(!allBanners){
continue;
}
var banners=allBanners['autocontext'];
