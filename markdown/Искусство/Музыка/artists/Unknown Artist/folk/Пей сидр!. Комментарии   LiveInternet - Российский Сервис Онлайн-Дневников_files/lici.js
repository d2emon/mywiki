...
----------------------------------------------- */
	...
	LiCi.getBrowser = {
		...
		chrome: /chrome/.test(LiCi.userAgent)
	};
...
----------------------------------------------- */ 		
	...
	LiCi.Notify.show = function (type,mess) {
		...
		process.innerHTML = '<div class="'+this.clName+'_mess '+this.types.insert(type,'class')+'"><em></em><p><b>'+this.types.insert(type,'text')+'</b> '+mess+'</p></div>';
	};
